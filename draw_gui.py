...
def init_gui(model, mapping, width=400, height=400):
    ...
    def show():
        ...
        label3_var.set('Handwritten: ' + text)
        print(text)
    ...
    def clear():
        ...
        label3_var.set('Handwritten: ' )

    frame = tk.Tk()
    frame.title('Final Year Project')
    ...
    button_show = tk.Button(frame, text='MultiWord', command=show)
    ...
    label3_var.set('Handwritten: ')
    label3 = tk.Label(frame, textvariable=label3_var)
